...
namespace TBS_Solr_Interface.WebUserControls
{
    public partial class SearchPageControl : System.Web.UI.UserControl
    {
        ...
        void loadSearchForm()
        {
            ...
            else if (String.IsNullOrEmpty(Request.QueryString["ctl00$CPHContent$SearchPageControl$q"]).Equals(_boolFalse))
                _gcsearch.queryBasic = Request.QueryString["ctl00$CPHContent$SearchPageControl$q"];
            else if (String.IsNullOrEmpty(Request.QueryString["ctl00$CPHContent$SearchPageControl2$q"]).Equals(_boolFalse))
                _gcsearch.queryBasic = Request.QueryString["ctl00$CPHContent$SearchPageControl2$q"];
            else if (String.IsNullOrEmpty(Request.Form["q"]).Equals(_boolFalse))
                _gcsearch.queryBasic = Request.Form["q"];
            else if (String.IsNullOrEmpty(Request.Form["ctl00$CPHContent$SearchPageControl$q"]).Equals(_boolFalse))
                _gcsearch.queryBasic = Request.Form["ctl00$CPHContent$SearchPageControl$q"];
            else if (String.IsNullOrEmpty(Request.Form["ctl00$CPHContent$SearchPageControl2$q"]).Equals(_boolFalse))
                _gcsearch.queryBasic = Request.Form["ctl00$CPHContent$SearchPageControl2$q"];
        ...
        {
            Response.Redirect(Request.Url.ToString() + "?q=" + Request.Form["ctl00$CPHContent$SearchPageControl$q"] + "&a=s&chk1=True" + "&chk2=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk2"] + "&chk3=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk3"] + "&chk4=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk4"] + "&s=" + Request.Form["ctl00$CPHContent$SearchPageControl$s"]);
        }

        protected void chk2_CheckedChanged(object sender, EventArgs e)
        {
            Response.Redirect(Request.Url.ToString() + "?q=" + Request.Form["ctl00$CPHContent$SearchPageControl$q"] + "&a=s&chk1=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk1"] + "&chk2=True" + "&chk3=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk3"] + "&chk4=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk4"] + "&s=" + Request.Form["ctl00$CPHContent$SearchPageControl$s"]);
        }

        protected void chk3_CheckedChanged(object sender, EventArgs e)
        {
            Response.Redirect(Request.Url.ToString() + "?q=" + Request.Form["ctl00$CPHContent$SearchPageControl$q"] + "&a=s&chk1=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk1"] + "&chk2=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk2"] + "&chk3=True" + "&chk4=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk4"] + "&s=" + Request.Form["ctl00$CPHContent$SearchPageControl$s"]);
        }

        protected void chk4_CheckedChanged(object sender, EventArgs e)
        {
            Response.Redirect(Request.Url.ToString() + "?q=" + Request.Form["ctl00$CPHContent$SearchPageControl$q"] + "&a=s&chk1=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk1"] + "&chk2=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk2"] + "&chk3=" + Request.Form["ctl00$CPHContent$SearchPageControl$chk3"] + "&chk4=True" + "&s=" + Request.Form["ctl00$CPHContent$SearchPageControl$s"]);
        }
    }
}